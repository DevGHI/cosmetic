          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <p class="text-sm mb-0 myanmar">
                Color အားလုံး ဖြစ်သည်။ Color ကိုဖျက်ပါက ဆက်စပ်နေသော Product, Order များပါပျက်ပါမည်။
              </p>
            </div>
        ...
        <form id="insert_form">
          <div class="modal-body">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Add Color:</label>
        ...
        <form id="update_form">
          <div class="modal-body">
            <input type="hidden" id="modal-id" name="id">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Update Color:</label>
...
@section('js')
  <script>
    $(document).ready( function () {
        ...
        function load_data(){
          var getAll_url = domain+'api/colors';
        ...
        delete_data=function(id){
          if(confirm('Are you sure want to delete!')==true){
            var delete_url = domain+'api/colors/'+id;
        ...
        document.getElementById('insert_form').addEventListener('submit',()=>{
              ...
              axios.post(domain+"api/colors",form,{
                headers: {
                  Authorization:TokenData.get()
                }
              })
        ...
        document.getElementById('update_form').addEventListener('submit',()=>{
              ...
              axios.post(domain+"api/colors/update/"+form.get('id'),form,{
                headers: {
                  Authorization:TokenData.get()
                }
              })
