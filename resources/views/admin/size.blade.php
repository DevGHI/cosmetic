        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Sizes</h6>
        ...
        <form id="insert_form">
          <div class="modal-body">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Add Size:</label>
        ...
        <form id="update_form">
          <div class="modal-body">
            <input type="hidden" id="modal-id" name="id">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Update Size:</label>
...
@section('js')
  <script>
    $(document).ready( function () {
        ...
        function load_data(){
          var getAll_url = domain+'api/sizes';
        ...
        delete_data=function(id){
          if(confirm('Are you sure want to delete!')==true){
            var delete_url = domain+'api/sizes/'+id;
        ...
        document.getElementById('insert_form').addEventListener('submit',()=>{
              ...
              axios.post(domain+"api/sizes",form,{
                headers: {
                  Authorization:TokenData.get()
                }
              })
        ...
        document.getElementById('update_form').addEventListener('submit',()=>{
              ...
              axios.post(domain+"api/sizes/update/"+form.get('id'),form,{
                headers: {
                  Authorization:TokenData.get()
                }
              })
